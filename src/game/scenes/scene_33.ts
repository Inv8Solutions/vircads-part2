...
export class Scene33 extends Scene {
    ...
    create() {
        ...
        // Bottom-center dialog with content
        const dialogW = Math.min(760, Math.round(width * 0.8));
        const padding = 12;
        const dialogText = `Evidence of trauma on the rib cage can:\n\n• Indicate the nature and force of injuries; and\n• Help reconstruct the circumstances surrounding death.`;
